...
//	this.last_sorted = -1;
	this.history = [];
	this.sort_keys = [];
	this.sort_colors = [ '#ffff00', '#ffaa00', '#ff0000' ]; //Yellow, Orange, Red
	/*[ '#ffff00', '#800080', '#FFFFFF' ]; //Yellow, Purple, White*/ /*[ '#FF0000', '#800080', '#0000FF' ]; //Red, Purple, Blue //Icon Colors*/
};
...
function tsRegister()
{
	...
	if	(ts_obj.icons == null)
		ts_obj.icons = new Array ("&#x25B2","&#x25BC");	/*UP DOWN Arrows ("\u2193", "\u2191");*/
